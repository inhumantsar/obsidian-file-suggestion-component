...
export class FileInputSuggest extends AbstractInputSuggest<TAbstractFile> {
    ...
    async selectSuggestion(file: TAbstractFile, evt: MouseEvent | KeyboardEvent) {
        // setValue was originally called from super rather than this.. i guess tho due to 
        // the way obsidian distributes their libraries, ancestors have be mocked entirely. 
        // this is fine for ancestor methods called with this, but calls made super result 
        // in a TypeError: Cannot read properties of undefined (reading 'call').
